...
std::vector< std::string > load_solution( int &solution_len )
{
    ...
    std::vector<std::vector<std::string>> all_solutions = {
        {"a", "bcdf", "bdef", "bgkm", "bhkm", "bn", "p"},        // task 1
        {"ab", "bcde", "efghi", "ikm", "n"},                     // task 2
        {"abd", "cbd", "defh", "fgh", "hik", "km"},              // task 3
        {"acde", "bcde", "degh", "efgh", "hik", "m"},            // task 4
        {"ac", "bcge", "cdfg", "ghk", "mik", "mn"},              // task 5
        {"a", "bcd", "deg", "gfh", "hik", "km"},                 // task 6
        {"a", "bcdg", "cdeg", "dfgi", "gikm", "mn"},             // task 7
        {"a", "bce", "deg", "ghf", "ghi"},                       // task 8
        {"abc", "bcd", "ce", "hif", "ghi", "ik"},                // task 9
        {"acde", "bcde", "defg", "dghi", "ik", "m"},             // task 10
        {"ad", "bcde", "cdef", "deg", "dhik", "km"},             // task 11
        {"a", "bc", "defg", "ghi", "k"},                         // task 12
        {"a", "bc", "cdef", "dghkm", "him", "n"},                // task 13
        {"ab", "bc", "cde", "ef", "fgh", "gkm", "kmp", "mn"},    // task 14
        {"ad", "bcdgh", "defhik", "emn", "np"},                  // task 15
        {"a", "bcef", "bdefg", "efgh", "ehi", "ik"},             // task 16
        {"abd", "bcd", "defh", "fgh", "hik", "km"},              // task 17
        {"abi", "bcdi", "befhi", "bfghi", "hik", "m"},           // task 18
        {"a", "bcdf", "defgik", "dhikm", "dkmn", "p"},           // task 19
        {"a", "bcf", "cdefg", "efghr", "egimnr", "gkmn", "gnp"}, // task 20
    };
    
    if (lab3_thread_graph_id() < 1 || lab3_thread_graph_id() > all_solutions.size())
        solution_len = -1;
    else {
        for ( auto &line: all_solutions[lab3_thread_graph_id()-1] ) {
...
TEST(lab3_tests, threadsync) {
    ...
    ASSERT_NE( solution_len, -1 ) << "Can't find solution. Did you mess up with project files?";
